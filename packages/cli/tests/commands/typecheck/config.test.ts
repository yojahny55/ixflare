...
describe('config', () => {
  ...
  describe('findTsConfig', () => {
    it('should find tsconfig.json when it exists', () => {
      ...
      expect(ts.findConfigFile).toHaveBeenCalledWith('/project', ts.sys.fileExists, 'tsconfig.json')
    })
    ...
    it('should use process.cwd() as default start directory', () => {
      ...
      expect(ts.findConfigFile).toHaveBeenCalledWith(cwd, ts.sys.fileExists, 'tsconfig.json')
    })
  })
